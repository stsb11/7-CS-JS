...
:END:
- *Silver:* Create a new file called Greeter.html
...
- *Gold:* Also complete these tasks...
  ...
  - Use a =window.alert()= box to display the message 'You will be 100 in the year ####' 
    - /HINT:/ the calculation is 100 - age + current year
